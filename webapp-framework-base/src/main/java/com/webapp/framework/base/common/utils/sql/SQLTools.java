...
public class SQLTools {
	...
	private static String getDateFormat(String jDateFormat) {
		if ((jDateFormat.toLowerCase().equals("yyyyMM")) || (jDateFormat.toLowerCase().equals("%Y%m"))) {
			return DBDialect.MYSQL == dbTYPE ? "%Y%m" : "yyyyMM";
		}
		if ((jDateFormat.toLowerCase().equals("yyyymmdd")) || (jDateFormat.toLowerCase().equals("%y%m%d"))) {
			return DBDialect.MYSQL == dbTYPE ? "%Y%m%d" : "yyyyMMdd";
		}
		if ((jDateFormat.toLowerCase().equals("yyyy-mm-dd")) || (jDateFormat.toLowerCase().equals("%y-%m-%d"))) {
		...
		if ((jDateFormat.toLowerCase().equals("yyyy-mm-dd hh:mm:ss"))
				|| (jDateFormat.toLowerCase().equals("yyyy-mm-dd hh24:mi:ss"))
				|| (jDateFormat.toLowerCase().equals("%y-%m-%d %h:%i:%s"))) {
