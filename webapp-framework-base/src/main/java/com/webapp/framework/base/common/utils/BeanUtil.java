...
import com.webapp.framework.base.common.utils.converter.ConvertRegisterHelper;

public class BeanUtil extends BeanUtils {
	protected static Logger log = LogManager.getLogger(BeanUtil.class);
	...
	public static String getFieldType(Class<?> c, String columnId) {
		try {
			String methodName = "get" + columnId.substring(0, 1).toUpperCase() + columnId.substring(1);
