...
public class DateUtil {
	...
	public static boolean isDateFormat(String datestr, String format) {
		...
		try {
			...
			return datestr.equals(sdf.format(d));
		} catch (Exception e) {
		}
		return false;
	}
