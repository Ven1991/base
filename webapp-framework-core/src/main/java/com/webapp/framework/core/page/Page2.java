package com.webapp.framework.core.page;
...
public class Page2 {  
  ...
  private static final Logger logger = LogManager.getLogger(Page2.class);  
  ...
  public static Page2 newBuilder(int pageNo, int pageSize, String url){  
