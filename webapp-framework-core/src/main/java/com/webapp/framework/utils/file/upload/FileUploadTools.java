...
{
  protected static Log log = LogFactory.getLog(FileUploadTools.class);
  ...
  {
    return loadWebUploadFile(request, "*.mpg;*.wmv;*.mp4;*.jpeg;*.png;*.jpg;*.gif;*.bmp;*.xls;*.xlsx;*.docx;*.ppt;*.pptx;*.txt;*.zip;", ALLOW_MAX_FILE_SIZE);
  }

  public static UploadFileBean loadWebUploadFile(HttpServletRequest request, String FileType)
    throws IOException
  {
  ...
  {
    return loadWebUploadFile(request, "*.mpg;*.wmv;*.mp4;*.jpeg;*.png;*.jpg;*.gif;*.bmp;*.xls;*.xlsx;*.docx;*.ppt;*.pptx;*.txt;*.zip;", FileSize);
  }
  ...
  {
    return webUploadFiles(request, "*.mpg;*.wmv;*.mp4;*.jpeg;*.png;*.jpg;*.gif;*.bmp;*.xls;*.xlsx;*.docx;*.ppt;*.pptx;*.txt;*.zip;", ALLOW_MAX_FILE_SIZE);
  }
  ...
  {
    return webUploadFiles(request, "*.mpg;*.wmv;*.mp4;*.jpeg;*.png;*.jpg;*.gif;*.bmp;*.xls;*.xlsx;*.docx;*.ppt;*.pptx;*.txt;*.zip;", fileSize);
  }

  public static List<UploadFileBean> webUploadFiles(HttpServletRequest request, String fileType, Long fileSize) throws IOException{
    MultipartResolver multipartResolver = new CommonsMultipartResolver(request
      .getSession().getServletContext());
...
//    int finaltime = keys; 
  ...
  private static UploadFileBean loadFileFromRequest(String inputName, MultipartFile file, Long fileSize, String fileType)
    throws IOException
  {
