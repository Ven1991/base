package com.webapp.framework.utils.file.ipseeker;
...
import com.webapp.framework.utils.file.ipseeker.util.IPEntry;
import com.webapp.framework.utils.file.ipseeker.util.IPLocation;
import com.webapp.framework.utils.file.ipseeker.util.Util;
...
public class IPSeeker
{
  ...
  private IPLocation getIPLocation(long offset)
  {
    try
    {
      ...
      return this.loc; } catch (IOException e) {
    }
    return null;
  }
